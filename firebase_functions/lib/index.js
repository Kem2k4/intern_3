...
exports.testFCMNotification = exports.handleCallTimeout = exports.cleanupOldCalls = exports.sendCallNotification = void 0;
...
exports.sendCallNotification = functions.database
    ...
    try {
        ...
        if (!callData || callData.status !== "calling") {
            console.log("⚠️  Skipping notification - invalid status:", callData === null || callData === void 0 ? void 0 : callData.status);
            return null;
        }
 ...
 */
exports.handleCallTimeout = functions.database
    .ref("/calls/{callId}")
    .onCreate(async (snapshot, context) => {
    const callId = context.params.callId;
    const callData = snapshot.val();
