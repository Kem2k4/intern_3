...
class AgoraService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      final videoConfig = AgoraConfigExtension.getVideoConfigForLivestream();
  ...
  Future<void> joinChannelAsBroadcaster(String channelName, {String? token}) async {
    ...
    try {
      // Stop preview before joining, as it's a separate state
  ...
  Future<void> dispose() async {
    ...
    try {
      ...
      // Release engine (this will automatically disable audio/video modules)
      if (_engine != null) {
