...
class $UserLoginsTable extends UserLogins with TableInfo<$UserLoginsTable, UserLogin> {
  @override
  ...
  static const VerificationMeta _isLoggedInMeta = const VerificationMeta('isLoggedIn');
  @override
  late final GeneratedColumn<bool> isLoggedIn = GeneratedColumn<bool>(
    ...
    defaultConstraints: GeneratedColumn.constraintIsAlways('CHECK ("is_logged_in" IN (0, 1))'),
    defaultValue: const Constant(false),
  );
  static const VerificationMeta _lastLoginMeta = const VerificationMeta('lastLogin');
  @override
  ...
  @override
  List<GeneratedColumn> get $columns => [id, email, userName, fullName, isLoggedIn, lastLogin];
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('is_logged_in')) {
      context.handle(
        _isLoggedInMeta,
        isLoggedIn.isAcceptableOrUnknown(data['is_logged_in']!, _isLoggedInMeta),
      );
    }
...
class UserLogin extends DataClass implements Insertable<UserLogin> {
  ...
  factory UserLogin.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
  ...
  UserLogin copyWithCompanion(UserLoginsCompanion data) {
    return UserLogin(
      ...
      isLoggedIn: data.isLoggedIn.present ? data.isLoggedIn.value : this.isLoggedIn,
  ...
  @override
  int get hashCode => Object.hash(id, email, userName, fullName, isLoggedIn, lastLogin);
  @override
  ...
  $$UserLoginsTableTableManager(_$AppDatabase db, $UserLoginsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          filteringComposer: $$UserLoginsTableFilterComposer(ComposerState(db, table)),
          orderingComposer: $$UserLoginsTableOrderingComposer(ComposerState(db, table)),
...
class $$UserLoginsTableFilterComposer extends FilterComposer<_$AppDatabase, $UserLoginsTable> {
...
class $$UserLoginsTableOrderingComposer extends OrderingComposer<_$AppDatabase, $UserLoginsTable> {
